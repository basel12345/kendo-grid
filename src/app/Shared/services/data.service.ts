    ...
    public fetch(filter: string): Observable<any> {
        const httpOptions = {
            headers: new HttpHeaders({
                ...
                "Authorization": "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..M0D2KXYJkCw9nDNqm0cUXmbTTOCf5vmd8X1fnKriFEE"
            })
        };
        return this.http
